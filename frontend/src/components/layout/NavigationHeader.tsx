...
const NavigationHeader: React.FC<NavigationHeaderProps> = ({
  ...
  return (
    <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
      {/* Mobile Header - Clean and Simple like Urban Company */}
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <button className="flex items-center gap-1">
            ...
            <div className="text-left">
              <p className="text-sm font-bold text-gray-900 leading-tight">{currentLocation}</p>
              <p className="text-xs text-gray-500 leading-tight truncate max-w-[180px]">Select your location</p>
            </div>
          ...
          <div className="flex items-center gap-2">
            {user ? (
              ...
              <button
                ...
                className="px-4 py-2 text-sm font-semibold text-nilin-primary"
              >
                Login
              </button>
            )}
          ...
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            {showSearch && (
              <form
                ...
                className="flex flex-1 max-w-md lg:max-w-lg"
              >
      ...
      {showMobileMenu && (
        <>
          ...
          />
          <div className="fixed inset-y-0 right-0 w-[300px] bg-white z-50 md:hidden shadow-2xl">
